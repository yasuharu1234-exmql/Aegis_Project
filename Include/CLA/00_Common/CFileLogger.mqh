...
public:
   ...
   int GetPanicCount() const
   {
      return m_panic_count;
   }
...
private:
   ...
   string GetLogName(int log_id)
   {
      ...
      // ========== 200番台: パニックログ ==========
      case 200:
         return "PANIC_RETRY_EXCEEDED";
      case 201:
         return "PANIC_BOTH_FILLED";
      case 202:
         return "PANIC_INCONSISTENT";
      case 203:
         return "PANIC_RECOVERY_FAILED";
      case 204:
         return "PANIC_DEINIT_ABNORMAL";

      // ========== 300番台: スポットログ ==========
      case 300:
         return "SPOT_TRACE";
      case 301:
         return "SPOT_STATE_DUMP";
      case 302:
         return "SPOT_SPREAD";
      case 303:
         return "SPOT_PRICE";
   ...
   string GetPanicTypeName(int panic_id)
   {
      ...
      case PANIC_UNKNOWN:
         return "UNKNOWN";
      case PANIC_MEMORY_CORRUPTION:
         return "MEMORY_CORRUPTION";
      case PANIC_ORDER_STATE_BROKEN:
         return "ORDER_STATE_BROKEN";
      case PANIC_EXECUTION_INCONSIST:
         return "EXECUTION_INCONSIST";
      case PANIC_LOGGER_FAILURE:
         return "LOGGER_FAILURE";
      case PANIC_INTERNAL_ASSERT:
         return "INTERNAL_ASSERT";
      case PANIC_MANUAL_TRIGGER:
         return "MANUAL_TRIGGER";
      default:
         return StringFormat("PANIC_%d", panic_id);
      }
   }
